...
//       <Text style={styles.questionText}>How much do you Height?</Text>

//       {/* LBS | KG Switch inside same box */}
//       <View style={styles.unitBox}>
//         <TouchableOpacity
//           style={[styles.unitOption, unit === 'FEET' && styles.unitActive]}
//           onPress={() => handleUnitSwitch('FEET')}
//         >
//           <Text style={[styles.unitText, unit === 'FEET' && styles.unitTextActive]}>
//             FEET
//           </Text>
//         </TouchableOpacity>
//         <TouchableOpacity
//           style={[styles.unitOption, unit === 'CM' && styles.unitActive]}
...
const HeightScreen = ({ navigation }) => {
  ...
  const handleContinue = () => {
    if (selectedConcern !== null) {
      alert(`Selected: ${selectedConcern.title}`);
